...
|---|---|---|
| `onLoad` | Function to be called on loading the form builder template data. | `(data) => { console.log(data) }` |
| `onUpload` | Function to be called on uploading a document to the template. | `(data) => { console.log(data) }` |
| `onSend` | Function to be called on sending documents for signature to recipients. | `(data) => { console.log(data) }` |
| `onChange` | Function to be called when changes are made to the template form. | `(data) => { console.log(data) }` |
| `onSave` | Function to be called on saving changes of the template form. | `(data) => { console.log(data) }` |
...
- [Generate JWT on your back-end to authorize users](form-builder-react-generate-jwt-on-your-back-end-to-authorize-users.md)
- [Mount form builder component with JSX](form-builder-react-mount-form-builder-component-with-jsx.md)
- [Styling the Builder with custom CSS](form-builder-react-styling-the-builder-with-custom-css.md)
